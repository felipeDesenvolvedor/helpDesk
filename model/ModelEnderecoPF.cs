...
namespace model
{
    public class ModelEnderecoPF:Conexao
    {
        ...
        public void gravarUsuarioModel()
        {
            ...
            parametrosProcedure.Add(Idpf);

            gravar(ENDERECOPF_INSERIR, parametrosProcedure);
        }
        ...
        public int excluirUsuarioModel()
        {
            ...
            return excluir(ENDERECOPF_EXCLUIR, parametrosProcedure);
        }
        ...
        public int editarUsuarioModel()
        {
            ...
            retorno = editar(ENDERECOPF_EDITAR, parametrosProcedure);
            return retorno;
        }
    }
}
